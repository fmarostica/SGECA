<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Ventas.master" AutoEventWireup="true" CodeBehind="FrmReporteVentas.aspx.cs" Inherits="SGECA.Forms.Ventas.FrmReporteVentas" %>
                    ...
                    <td>
                        ...
                        <asp:Label runat="server" ID="textLabel" />
                                ...
                                <asp:Panel runat="server" ID="panel2" Width="98%" HorizontalAlign="center">
                                    <table cellspacing="10" style="margin: 0 auto; text-align: left;">
                                        ...
                                        <tr>
                                            <td>Titulo:</td>
                                            <td>
                                                <asp:TextBox ID="txtTitulo" runat="server" CssClass="input1 input1Altura">Reporte de Ventas</asp:TextBox>
                                            </td>
                                            <td style="width: 80px; position: relative; top: -3px;">Cliente:</td>
                                            <td class="auto-style1">
                                ...
                                <rsweb:ReportViewer ID="rv1" runat="server"
                                    ...
                                    Height="500px" Width="100%" ShowPrintButton="true"
                                    PageCountMode="Actual" ShowDocumentMapButton="true" ShowZoomControl="true">
