...
{
    public partial class FrmReporteVentas : System.Web.UI.Page, LogManager.ISubject, LogManager.IObserver
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //txtDesde.Value = "01/01/2000";
            //txtHasta.Value = "01/01/2016";
            if (!IsPostBack)
            {
                cargarClientes();
            }
        ...
        protected void btnGenerar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                mostrar(aux1, aux2, txtTitulo.Text, int.Parse(ddlCliente.SelectedValue));
        ...
        public void mostrar(DateTime desde, DateTime hasta, string titulo, int cliente)
        {
            try
            {
                if (titulo == "")
                ...
                dt = liv.obtener(desde, hasta, cliente, dtName);


                rv1.LocalReport.ReportPath = Server.MapPath("~/Reports/VentasReporte.rdlc");
                ...
                rv1.LocalReport.SetParameters(new ReportParameter("Folio", "0"));
