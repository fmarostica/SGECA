<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Produccion.master" AutoEventWireup="true" CodeBehind="frmReporteRendicion.aspx.cs" Inherits="SGECA.Forms.Empleados.frmReportes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContenido" runat="server">
    <script>
        $("#mTitle").text("REPORTE DE RENDICION");
        ...
        function Confirmar()
        {
            if($("#<%=txtFechaCierre.ID%>").val()!="")
            {
                if (confirm("¿Esta seguro que desea generar el reporte y asignar las fecha de cierre a los empleados seleccionados?"))
                {
                    doClose();
                    return true;
                }
    ...
    <ajaxToolkit:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server"></ajaxToolkit:ToolkitScriptManager>
        <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Always">
                    <ContentTemplate>
                        ...
                        <asp:Button ID="btnGenerar" Text="GENERAR" CssClass="buttonMenu" ClientIDMode="Static" runat="server" OnClick="btnGenerar_Click" OnClientClick="return Confirmar()"  />
                        ...
                        <div class="main_contenido">
                            ...
                            <asp:Panel ID="panelMain" runat="server">
                                ...
                                <asp:Label ID="lblFechaCierre" Text="Fecha de cierre : " CssClass="lblField" runat="server"></asp:Label>
                                <asp:TextBox ID="txtFechaCierre" ClientIDMode="Static" CssClass="input1" runat="server" Width="80px"></asp:TextBox>
