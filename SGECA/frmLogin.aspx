<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmLogin.aspx.cs" Inherits="SGECA.frmLogin" %>
    ...
    <div class="cuadro800">
        ...
        <div class="cuadroLogin" >
            <div class="cuadroLogin_contenido">
                <b>Identifíquese para acceder al sistema </b>
                <br /><br />
                Recuérdelo: su clave es única e intransferible y le garantiza la confidencialidad de la información brindada.
                ...
                <table>
                    <tr>
                        ...
                        <td><asp:TextBox ID="txtUsuario" ClientIDMode="Static" runat="server"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td>Contraseña : </td>
                        <td><asp:TextBox ID="txtPass" ClientIDMode="Static" TextMode="Password" runat="server"></asp:TextBox></td>
                    </tr>
                </table>
                <br />
                <asp:Button ID="btnIngresar" runat="server" CssClass="buttonModal" Text="Ingresar" OnClick="btnIngresar_Click"/>
                <hr style="width: 90%; margin-top: 15px; margin-bottom: 25px" />
                <div style="text-align: left">
                    <a href="frmForgotPass.aspx">¿Olvidó su contraseña?</a>
                    <br /><asp:CheckBox Text="Recordar mi contraseña" runat="server" />
                </div>
