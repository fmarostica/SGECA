...
namespace SGECA.DAL
{
    public class ConceptoVenta : LogManager.ISubject, LogManager.IObserver, IConceptoVenta
    {
        ...
        //la programación
        private static string dbCampoId = "cvt_codigo";
        private static string dbCampoNombre = "cvt_nombre";
        private static string dbTabla = "conceptoventa";
        ...
        /// </summary>
        public static List<IConceptoVenta> obtener()
        {
            //limpiaDatos();
            List<IConceptoVenta> retorno = new List<IConceptoVenta>();
            ...
            try
            {
                ...
                while (dr.Read())
                {
                    ConceptoVenta p = new ConceptoVenta();
                    cargarDatos(p, dr);
                    retorno.Add(p);
                }
                dr.Close();
        ...
        private static void cargarDatos(ConceptoVenta objeto, MySqlDataReader dr)
        {
        ...
        public void obtener(string codigo)
        {
            ...
            comando.Parameters.AddWithValue(dbCampoNombre, codigo);
            comando.Transaction = Database.obtenerTransaccion();
        ...
        /// 
        /// <summary>
        public List<ConceptoVenta> obtenerFiltrado(ItemFiltro[] itemFiltro,
            ItemOrden[] orden, bool busquedaAnd, double inicio, double fin, out double totalRegistros)
        {
            List<ConceptoVenta> ret = new List<ConceptoVenta>();
            UltimoMensaje = null;
            MySqlConnection conexion = Database.obtenerConexion(true);
            ...
            try
            {
                ...
                while (dr.Read())
                {
                    ConceptoVenta bar = new ConceptoVenta();
                    bar.Subscribe(this);
