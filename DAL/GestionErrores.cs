...
namespace SGECA.DAL
{
    public class GestionErrores
    {
        ...
        public static LogManager.Mensaje obtenerError(Exception excepcion)
        {
            LogManager.Mensaje retorno = new LogManager.Mensaje();
        ...
        private static void obtenerException(Exception excepcion, LogManager.Mensaje mensaje)
        {
        ...
        private static void obtenerSqlException(System.Data.SqlClient.SqlException excepcion, LogManager.Mensaje mensaje)
        {
                ...
                excepcion.Class == 16)
            {
                ...
                mensaje.TipoMensaje = LogManager.EMensaje.Advertencia;
            }
