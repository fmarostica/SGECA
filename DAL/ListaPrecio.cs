...
namespace SGECA.DAL
{
    public class ListaPrecio : LogManager.ISubject, LogManager.IObserver, IListaPrecio
    {
        ...
        //la programación
        private static string dbCampoId = "lpr_Id";
        private static string dbCampoNombre = "lpr_nombre";
        private static string dbTabla = "listaPrecio";
        ...
        /// </summary>
        public static List<IListaPrecio> obtener()
        {
            //limpiaDatos();
            List<IListaPrecio> retorno = new List<IListaPrecio>();
        ...
        private static void cargarDatos(ListaPrecio objeto, MySqlDataReader dr)
        {
            int id = 0;
        ...
        /// 
        /// <summary>
        public List<ListaPrecio> obtenerFiltrado(ItemFiltro[] itemFiltro,
            ItemOrden[] orden, bool busquedaAnd, double inicio, double fin, out double totalRegistros)
        {
            List<ListaPrecio> ret = new List<ListaPrecio>();
            UltimoMensaje = null;
            MySqlConnection conexion = Database.obtenerConexion(true);
            ...
            try
            {
                ...
                while (dr.Read())
                {
                    ListaPrecio bar = new ListaPrecio();
                    bar.Subscribe(this);
