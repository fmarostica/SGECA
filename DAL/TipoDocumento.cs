...
namespace SGECA.DAL
{
    public class TipoDocumento : LogManager.ISubject, LogManager.IObserver, ITipoDocumento
    {
        ...
        //la programación
        private static string dbCampoId = "tdo_codigo";
        private static string dbCampoNombre = "tdo_nombre";
        private static string dbTabla = "tipodocumento";
        ...
        /// </summary>
        public static List<ITipoDocumento> obtener()
        {
            //limpiaDatos();
            List<ITipoDocumento> retorno = new List<ITipoDocumento>();
        ...
        private static void cargarDatos(TipoDocumento objeto, MySqlDataReader dr)
        {
        ...
        /// 
        /// <summary>
        public List<TipoDocumento> obtenerFiltrado(ItemFiltro[] itemFiltro,
            ItemOrden[] orden, bool busquedaAnd, double inicio, double fin, out double totalRegistros)
        {
            List<TipoDocumento> ret = new List<TipoDocumento>();
            UltimoMensaje = null;
            MySqlConnection conexion = Database.obtenerConexion(true);
            ...
            try
            {
                ...
                while (dr.Read())
                {
                    TipoDocumento bar = new TipoDocumento();
                    bar.Subscribe(this);
