...
namespace SGECA.DAL
{
    public class CondicionVenta : LogManager.ISubject, LogManager.IObserver, ICondicionVenta
    {
        ...
        //la programación
        private static string dbCampoId = "cva_codigo";
        private static string dbCampoNombre = "cva_nombre";
        private static string dbTabla = "condicionVenta";
        ...
        /// </summary>
        public static List<ICondicionVenta> obtener()
        {
            //limpiaDatos();
            List<ICondicionVenta> retorno = new List<ICondicionVenta>();
        ...
        private static void cargarDatos(CondicionVenta objeto, MySqlDataReader dr)
        {
        ...
        /// 
        /// <summary>
        public List<CondicionVenta> obtenerFiltrado(ItemFiltro[] itemFiltro,
            ItemOrden[] orden, bool busquedaAnd, double inicio, double fin, out double totalRegistros)
        {
            List<CondicionVenta> ret = new List<CondicionVenta>();
            UltimoMensaje = null;
            MySqlConnection conexion = Database.obtenerConexion(true);
            ...
            try
            {
                ...
                while (dr.Read())
                {
                    CondicionVenta bar = new CondicionVenta();
                    bar.Subscribe(this);
        ...
        #region Miembros de ICondicionVenta
