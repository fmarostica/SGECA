...
namespace SGECA.DAL
{
    public class PuntoVenta : LogManager.ISubject, LogManager.IObserver, IPuntoVenta
    {
        ...
        //la programación
        private static string dbCampoId = "pvt_codigo";
        private static string dbCampoNombre = "pvt_descripcion";
        private static string dbTabla = "puntodeventa";
        ...
        /// </summary>
        public static List<IPuntoVenta> obtener()
        {
            //limpiaDatos();
            List<IPuntoVenta> retorno = new List<IPuntoVenta>();
        ...
        private static void cargarDatos(PuntoVenta objeto, MySqlDataReader dr)
        {
        ...
        /// 
        /// <summary>
        public List<PuntoVenta> obtenerFiltrado(ItemFiltro[] itemFiltro,
            ItemOrden[] orden, bool busquedaAnd, double inicio, double fin, out double totalRegistros)
        {
            List<PuntoVenta> ret = new List<PuntoVenta>();
            UltimoMensaje = null;
            MySqlConnection conexion = Database.obtenerConexion(true);
